    ...
    <form id="branchForm" action="#" method="POST">
        <div class="formSect active">
            ...
            <div class="from-group" style="padding: 0 30px 0 30px">
                <p>You are about to delete this product, <strong>{{$product->name}}</strong>?</p>
            </div>
            <div class="btns mt-3" style="margin: 0 30px 20px 30px">
                <a href="#" class="std-btn"
                    onclick="openModal({'url':'{{ route('product.delete',[$product->id]) }}','modalId':'ajaxModal','method':'GET'})">Delete</a>
                    <a href="#" class="std-btn"
        ...
        <div id="add_branch_form_sect" class="formSect">
            ...
            <div class="btns mt-3" style="padding: 0 30px 20px 30px">
                <a href="#" class="std-btn" onclick="getView({'url':'{{route('products.index')}}','view':'ajax-view','modalId':'ajaxModal'})" style="border-right: none">Done</a>
            </div>
