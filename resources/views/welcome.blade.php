                ...
                <form method="POST" action="{{ route('login') }}" style="padding: 20px;float: left;width: 100%">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            <input id="email" placeholder="Enter email..." type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus style="border-bottom: none;background: transparent;">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                                <div class="col-md-12">
                                <input id="password" placeholder="Enter password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" style="border: none;background: transparent;">
